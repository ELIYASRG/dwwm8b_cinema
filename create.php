...
// die();
    ...
    if ( $_SERVER['REQUEST_METHOD'] == "POST" ) 
    {
        ...
        if ( isset($post_clean['actors']) )
        {
            ...
            {
                $create_form_errors['actors'] = "Le nom du ou des acteurs doit contenir au maximum 255 caracatères.";
            }
        }
        ...
        if ( isset($post_clean['review']) )
        {
            ...
            {
                $create_form_errors['review'] = "La note est obligatoireee.";
            }
            ...
            {
                $create_form_errors['review'] = "La note doit être compris entre 0 et 5.";
            }
        }
